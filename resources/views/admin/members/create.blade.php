    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15">
                <a href="{{route('admin.members.index')}}" class="btn btn-custom dropdown-toggle waves-effect waves-light" >رجوع لإدارة  اعضاء  الفهدة <span class="m-l-5"><i class="fa fa-reply"></i></span></a>
            </div>
